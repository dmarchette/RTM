...
\index{R Libraries!OAIHarvester}
\index{R Libraries!XML}
\label{jss.obtain}
<<jssdata1,tidy=FALSE>>=
library(OAIHarvester)
...
the \texttt{RISmed}\index{R Libraries!RISmed}
...
The \texttt{languageR}\index{R Libraries!languageR}
...
@
The \texttt{maxent}\index{R Libraries!maxent}
...
\texttt{textir}\index{R Libraries!textir} package contains phrase counts
